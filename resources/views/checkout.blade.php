    ...
    <div class="container">
        <div class="col-6">
            {{-- <form method="POST" id="codForm" action="{{ route('checkoutpost', ['id' => $post->id]) }}"> --}}
                ...
                <button class="btn btn-warning"type="submit" style="margin-left: 2rem" id="doneButton-{{ $post->id }}">DONE</button>
...
@endif --}}
    ...
    {{-- <script>
        // Output the $posts data as a JavaScript variable
    ...
    {{-- <script>
        ...
        // Now you can use the "posts" variable in your JavaScript code
